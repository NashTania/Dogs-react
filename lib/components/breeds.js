...
var _breedsList = _interopRequireDefault(require("./breeds-list.js"));
...
function (_React$Component) {
  ...
  function Breeds(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Breeds).call(this, props));
    _this.state = {
      breeds: {}
    };
    return _this;
  ...
  _createClass(Breeds, [{
    ...
    value: function render() {
      ...
      }, "Back")), _react.default.createElement(_breedsList.default, {
